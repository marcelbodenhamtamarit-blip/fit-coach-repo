...
export function OverviewSection({
  ...
  // 13-week savings trend, for the chart
  ...
  const weekActivities = activities.length // Intervals endpoint already scopes to recent window
    ...
    <div className="space-y-5">
      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          <MiniStat label="Actividades" value={hasFitness ? String(activities.length) : "--"} tone="neutral" />
        </div>
      </Card>
